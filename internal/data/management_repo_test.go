...
func TestManagementRepoDeleteCredentialGraphByBindingIDRemovesBindingRows(t *testing.T) {
	...
	require.NoError(t, db.Exec(`INSERT INTO runtime_artifacts (platform_account_id, artifact_type, artifact_value, scope_key, expires_at) VALUES
		('binding_42_10001', 'authkey', 'artifact-42', '1008611', ?),
		('binding_7_20002', 'authkey', 'artifact-7', '2008611', ?)`, now.Add(time.Hour), now.Add(time.Hour)).Error)
